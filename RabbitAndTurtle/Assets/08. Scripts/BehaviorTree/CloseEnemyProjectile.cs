...
public class CloseEnemyProjectile : MonoBehaviour
{
    ...
    private void PlayAnimation()
    {
        switch (dir)
        {
            case "Front": ani.Play("BaataSwingFront"); break;
            case "Back": ani.Play("BaataSwingBack"); break;
            case "Left": ani.Play("BaataSwingLeft"); break;
            case "Right": ani.Play("BaataSwingRight"); break;
        }
    }
